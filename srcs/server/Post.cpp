...
namespace HDE
{
	...
	// 	{
	// 		cout << "found boundary & content type" << endl;
	...
	// 			next_file_name = content.substr(filename_index + 10);
	// 			next_file_name = next_file_name.substr(0, next_file_name.find("\""));
	// 			next_file_path = "./" + root + "/" + next_file_name;
	// 			if (this->curr_post_file_path == "")
	// 				this->curr_post_file_path = next_file_path;
	// 			cout << this->curr_post_file_path << endl;
	// 		}

	// 		// find another boundary or an end boundary
	// 		boundary_index = content.find("--" + boundary_string, content_type_index);

	// 		data_start_index = content.find("\r\n\r\n", content_type_index);
	// 		if (data_start_index != string::npos)
	// 		{
	// 			file_content = content.substr(data_start_index + 4); // start after \r\n\r\n, end before next boundary // boundary end

	// 			if (boundary_end_index != string::npos)
	// 			{
	// 				cout << "found end boundary" << endl;
	// 				file_content = file_content.substr(0, file_content.find("--" + boundary_string + "--") - 4);
	// 				this->status = DONE;
	// 			}
	// 			else if (boundary_index != string::npos)
	// 			{
	// 				cout << "found next boundary" << endl;
	// 				file_content = file_content.substr(0, file_content.find("--" + boundary_string) - 4);
	// 			}
	// 		}
